...
public class ApplicationGinModule extends AbstractGinModule {
	...
	protected void configure() {
		// declare a binding for the display area. You may need to use
		// annotations to identify the various display areas to match them to
		// the right activity manager.
		bind(MainView.class);
