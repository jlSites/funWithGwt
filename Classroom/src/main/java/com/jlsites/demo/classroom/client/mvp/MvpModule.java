...
public class MvpModule extends AbstractGinModule {
  ...
  /**
   * Creates a new PlaceHistoryHandler. This object is responsible handling navigation based on the
   * browser URL. You only need one of those for the entire app.
   * 
  ...
  /**
   * NOWHERE Creates a new PlaceController. The place controller is used by the PlaceHistoryHandler
   * and activities to tell the app to navigate to a different place. You only need one for the
   * entire app. However, it is essential for it to get instantiated in order for the application
   * navigation to work.
   * 
   * @param eventBus the event bus.
   * @return
